...
public class mergeTwoLists {
    ...
    public static void makeMergeTwoLists(SLL<Integer> list1, SLL<Integer> list2) {
        ...
        while(temp1 != null) {
            while(temp2 != null) {
                ...
                if(temp1.element.equals(temp2.element)) {
                    newList.insertLast(temp1.element);
                    newList.insertLast(temp2.element);
                    temp2 = temp2.succ;
                    temp1 = temp1.succ;
                }
